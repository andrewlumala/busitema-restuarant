...
const ordersRoutesFactory = require('./orders');
const guestOrdersRoutesFactory = require('./guest-orders');
const momoWebhookRoutesFactory = require('./momo-webhook');
const ratingsRoutes = require('./ratings');
const disputesRoutesFactory = require('./disputes');
